...
&SCOPED-DEFINE Program              WMS0314A
...
&Scoped-Define ENABLED-OBJECTS rtKey rtMold rtToolBar f-desc-item ~
...
DEFINE FRAME fPage0
     tt_wms_item_documento.id_documento AT ROW 1.33 COL 17 COLON-ALIGNED WIDGET-ID 76
          VIEW-AS FILL-IN 
          SIZE 15 BY .88
     tt_wms_item_documento.id_item_documento AT ROW 1.33 COL 50 COLON-ALIGNED WIDGET-ID 78
          VIEW-AS FILL-IN 
          SIZE 15 BY .88
     tt_wms_item_documento.sequencia AT ROW 2.79 COL 17 COLON-ALIGNED WIDGET-ID 88
          VIEW-AS FILL-IN 
          SIZE 4 BY .88
     tt_wms_item_documento.cod_item AT ROW 2.79 COL 33 COLON-ALIGNED WIDGET-ID 80
          VIEW-AS FILL-IN 
          SIZE 17 BY .88
     f-desc-item AT ROW 2.79 COL 50 COLON-ALIGNED NO-LABEL WIDGET-ID 90
     tt_wms_item_documento.referencia AT ROW 3.79 COL 17 COLON-ALIGNED WIDGET-ID 86
          VIEW-AS FILL-IN 
          SIZE 20 BY .88
     tt_wms_item_documento.lote AT ROW 3.79 COL 50 COLON-ALIGNED WIDGET-ID 82
          VIEW-AS FILL-IN 
          SIZE 20 BY .88
     tt_wms_item_documento.qtde_item AT ROW 4.79 COL 17 COLON-ALIGNED WIDGET-ID 84
          VIEW-AS FILL-IN 
          SIZE 17 BY .88
     cb-status-item-docto-wms AT ROW 4.79 COL 50 COLON-ALIGNED WIDGET-ID 106
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tt_wms_item_documento T "?" NO-UNDO emscustom wms_item_documento
      ADDITIONAL-FIELDS:
          FIELD r-rowid AS ROWID
      END-FIELDS.
   END-TABLES.
