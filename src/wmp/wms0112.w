...
DEFINE TEMP-TABLE tt_wms_doca NO-UNDO LIKE wms_doca
...
&SCOPED-DEFINE Program              WMS0112
&SCOPED-DEFINE Version              1.00.00.000

&SCOPED-DEFINE DBOTable             wms_doca
&SCOPED-DEFINE DBOProgram           wmbo/bowms029.p
...
&SCOPED-DEFINE ProgramZoom          wmzoom/z01wms029.w
...
&SCOPED-DEFINE page0KeyFields       {&DBOTempTable}.id_doca        
&SCOPED-DEFINE page0DisplayFields   {&DBOTempTable}.descricao ~
                                    {&DBOTempTable}.cod_estabel ~
...
&Scoped-Define ENABLED-FIELDS tt_wms_doca.id_doca tt_wms_doca.descricao ~
tt_wms_doca.cod_estabel tt_wms_doca.cod_depos 
&Scoped-define ENABLED-TABLES tt_wms_doca
&Scoped-define FIRST-ENABLED-TABLE tt_wms_doca
...
btSave btQueryJoins btReportsJoins btExit btHelp f-nome-estab ~
f-nome-deposito 
&Scoped-Define DISPLAYED-FIELDS tt_wms_doca.id_doca tt_wms_doca.descricao ~
tt_wms_doca.cod_estabel tt_wms_doca.cod_depos 
&Scoped-define DISPLAYED-TABLES tt_wms_doca
&Scoped-define FIRST-DISPLAYED-TABLE tt_wms_doca
&Scoped-Define DISPLAYED-OBJECTS f-nome-estab f-nome-deposito 
...
DEFINE FRAME fPage0
     ...
     btHelp AT ROW 1.13 COL 86.72 HELP
          "Ajuda"
     tt_wms_doca.id_doca AT ROW 2.88 COL 20 COLON-ALIGNED WIDGET-ID 76
          VIEW-AS FILL-IN 
          SIZE 4 BY .88
     tt_wms_doca.descricao AT ROW 4.25 COL 20 COLON-ALIGNED WIDGET-ID 74
          VIEW-AS FILL-IN 
          SIZE 40 BY .88
     tt_wms_doca.cod_estabel AT ROW 5.25 COL 20 COLON-ALIGNED WIDGET-ID 88
          VIEW-AS FILL-IN 
          SIZE 6 BY .88
     f-nome-estab AT ROW 5.25 COL 26.29 COLON-ALIGNED NO-LABEL WIDGET-ID 82
     tt_wms_doca.cod_depos AT ROW 6.25 COL 20 COLON-ALIGNED WIDGET-ID 86
          VIEW-AS FILL-IN 
          SIZE 4 BY .88
     f-nome-deposito AT ROW 6.25 COL 24.29 COLON-ALIGNED NO-LABEL WIDGET-ID 84
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tt_wms_doca T "?" NO-UNDO mgesp wms_doca
      ADDITIONAL-FIELDS:
          FIELD r-rowid AS ROWID
      END-FIELDS.
   END-TABLES.
...
&winName="Doca" &winSize=2
&gotoField1=id_doca &sizeField1=11
}
/**/
RETURN "OK":U .
END PROCEDURE.
