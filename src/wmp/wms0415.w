...
DEFINE VARIABLE f-id-etiqueta AS INTEGER FORMAT ">>>,>>>,>>9":U INITIAL 0 
     LABEL "Etiqueta a ser Fracionada" 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE f-qtde-separar AS INTEGER FORMAT ">>>,>>>,>>9":U INITIAL 0 
     LABEL "Quantidade Separar da Etiqueta" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     f-id-etiqueta AT ROW 1.25 COL 25 COLON-ALIGNED WIDGET-ID 2
     f-qtde-etiqueta AT ROW 1.25 COL 53 COLON-ALIGNED WIDGET-ID 12
     f-qtde-separar AT ROW 2.25 COL 25 COLON-ALIGNED WIDGET-ID 10
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
/* SETTINGS FOR FRAME f-pg-sel
                                                                        */
/* SETTINGS FOR FILL-IN f-qtde-etiqueta IN FRAME f-pg-sel
   NO-ENABLE                                                            */
...
&Scoped-define SELF-NAME f-id-etiqueta
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL f-id-etiqueta w-relat
ON LEAVE OF f-id-etiqueta IN FRAME f-pg-sel /* Etiqueta a ser Fracionada */
DO:
    ASSIGN iCont = 0 .
    IF INPUT FRAME f-pg-sel f-id-etiqueta <> "0" THEN
    DO:
        FOR EACH wms_etiqueta NO-LOCK
            WHERE wms_etiqueta.id_etiqueta_agrup = INT(INPUT FRAME f-pg-sel f-id-etiqueta)
            :
            ASSIGN iCont = iCont + wms_etiqueta.quantidade_etiqueta .
        END.
        ASSIGN f-qtde-etiqueta:SCREEN-VALUE = STRING(iCont) .   
    END.
END.
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY f-id-etiqueta f-qtde-etiqueta f-qtde-separar 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE f-id-etiqueta f-qtde-separar 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.empresa         = i-ep-codigo-usuario
        ...
        .
    /*Selecao*/
    ASSIGN tt-param.id-etiqueta    = INT(INPUT FRAME f-pg-sel f-id-etiqueta)
           tt-param.qtde-separar   = INT(INPUT FRAME f-pg-sel f-qtde-separar) 
        .
