...
DEFINE TEMP-TABLE tt_wms_deposito NO-UNDO LIKE wms_deposito
...
&SCOPED-DEFINE Program              WMS0102
&SCOPED-DEFINE Version              1.00.00.000

&SCOPED-DEFINE DBOTable             wms_deposito
&SCOPED-DEFINE DBOProgram           wmbo/bowms002.p
...
&SCOPED-DEFINE ProgramZoom          wmzoom/z01wms002.w
...
&SCOPED-DEFINE page0KeyFields       {&DBOTempTable}.cod_depos         
...
&Scoped-Define ENABLED-FIELDS tt_wms_deposito.cod_depos 
&Scoped-define ENABLED-TABLES tt_wms_deposito
&Scoped-define FIRST-ENABLED-TABLE tt_wms_deposito
...
&Scoped-Define DISPLAYED-FIELDS tt_wms_deposito.cod_depos 
&Scoped-define DISPLAYED-TABLES tt_wms_deposito
&Scoped-define FIRST-DISPLAYED-TABLE tt_wms_deposito
...
DEFINE FRAME fPage0
     ...
     btHelp AT ROW 1.13 COL 86.72 HELP
          "Ajuda"
     tt_wms_deposito.cod_depos AT ROW 2.88 COL 24 COLON-ALIGNED WIDGET-ID 60
          VIEW-AS FILL-IN 
          SIZE 4 BY .88
     f-nome AT ROW 2.88 COL 28 COLON-ALIGNED NO-LABEL WIDGET-ID 58
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tt_wms_deposito T "?" NO-UNDO mgesp wms_deposito
      ADDITIONAL-FIELDS:
          FIELD r-rowid AS ROWID
      END-FIELDS.
   END-TABLES.
...
DO:
    ...
    WHERE deposito.cod-depos = INPUT FRAME fPage0 {&DBOTempTable}.cod_depos NO-ERROR.
    IF AVAIL deposito THEN
    DO:
        ASSIGN f-nome:SCREEN-VALUE IN FRAME fPage0 = deposito.nome .
    END.
END.
...
{cstddk/include/wWinGoToRecord.i
    &winName="Deposito" &winSize=2
    &gotoField1=cod_depos &sizeField1=11
    }
