...
DEFINE TEMP-TABLE tt_wms_item_qualidade NO-UNDO LIKE wms_item_qualidade
...
&SCOPED-DEFINE Program              WMS0107D
&SCOPED-DEFINE Version              1.00.00.000

&SCOPED-DEFINE DBOParent            wms_item
&SCOPED-DEFINE DBOTable             wms_item_qualidade
&SCOPED-DEFINE DBOTempTable         tt_wms_item_qualidade
&SCOPED-DEFINE DBOProgram           wmbo/bowms033.p
...
&SCOPED-DEFINE page0DisplayFields   tg-armazena_avaria tg-armazena_amostra
...
&Scoped-Define ENABLED-FIELDS tt_wms_item_qualidade.cod_item ~
tt_wms_item_qualidade.id_endereco 
&Scoped-define ENABLED-TABLES tt_wms_item_qualidade
&Scoped-define FIRST-ENABLED-TABLE tt_wms_item_qualidade
...
tg-armazena_avaria tg-armazena_amostra btOk btSave btCancel 
&Scoped-Define DISPLAYED-FIELDS tt_wms_item_qualidade.cod_item ~
tt_wms_item_qualidade.id_endereco 
&Scoped-define DISPLAYED-TABLES tt_wms_item_qualidade
&Scoped-define FIRST-DISPLAYED-TABLE tt_wms_item_qualidade
...
tg-armazena_avaria tg-armazena_amostra 
...
DEFINE VARIABLE tg-armazena_amostra AS LOGICAL INITIAL no 
     LABEL "Armazena Amostra" 
     VIEW-AS TOGGLE-BOX
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE tg-armazena_avaria AS LOGICAL INITIAL no 
     LABEL "Armazena Avaria" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME fPage0
     tt_wms_item_qualidade.cod_item AT ROW 1.33 COL 20 COLON-ALIGNED WIDGET-ID 130
          VIEW-AS FILL-IN 
          SIZE 17 BY .88
     f-desc-item AT ROW 1.33 COL 37 COLON-ALIGNED NO-LABEL WIDGET-ID 98
     tt_wms_item_qualidade.id_endereco AT ROW 2.33 COL 20 COLON-ALIGNED WIDGET-ID 132
          VIEW-AS FILL-IN 
          SIZE 10 BY .88
     ...
     tg-armazena_avaria AT ROW 4.33 COL 22 WIDGET-ID 124
     tg-armazena_amostra AT ROW 4.33 COL 39 WIDGET-ID 126
     btOk AT ROW 5.79 COL 3.14 HELP
          "Salva e sai" WIDGET-ID 60
     btSave AT ROW 5.79 COL 14.14 HELP
          "Salva e cria novo registro" WIDGET-ID 64
     btCancel AT ROW 5.79 COL 25.14 HELP
          "Cancela" WIDGET-ID 62
     rtKey AT ROW 1 COL 1 WIDGET-ID 26
     rtToolBar AT ROW 5.5 COL 1 WIDGET-ID 48
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tt_wms_item_qualidade T "?" NO-UNDO mgesp wms_item_qualidade
      ADDITIONAL-FIELDS:
          FIELD r-rowid AS ROWID
      END-FIELDS.
   END-TABLES.
...
ON 'VALUE-CHANGED':U OF tg-armazena_amostra DO:
    ASSIGN {&DBOTempTable}.armazena_amostra = tg-armazena_amostra:CHECKED .
END.

ON 'VALUE-CHANGED':U OF tg-armazena_avaria DO:
    ASSIGN {&DBOTempTable}.armazena_avaria = tg-armazena_avaria:CHECKED .
END.
...
DO WITH FRAME fPage0
    ...
    ASSIGN
        tg-armazena_amostra:CHECKED = {&DBOTempTable}.armazena_amostra
        tg-armazena_avaria:CHECKED  = {&DBOTempTable}.armazena_avaria
        . 
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE beforeDisplayFields wWindow 
