...
/*
Autor: JosÇ Telles
Objetivo: Espec°fico Finalizar Recebimento
*/
...
DEFINE VARIABLE cb-opcao AS CHARACTER FORMAT "X(10)":U 
     LABEL "Opá∆o" 
     VIEW-AS COMBO-BOX INNER-LINES 5
     LIST-ITEM-PAIRS "Finalizar","1",
                     "Cancelar","2"
     DROP-DOWN-LIST
...
DEFINE FRAME f-pg-sel
     f-id-documento AT ROW 1.25 COL 17 COLON-ALIGNED
     cb-opcao AT ROW 2.25 COL 17 COLON-ALIGNED WIDGET-ID 6
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY f-id-documento cb-opcao 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE f-id-documento cb-opcao 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    ASSIGN
        ...
        tt-param.opcao = INT(INPUT FRAME f-pg-sel cb-opcao)
        .
