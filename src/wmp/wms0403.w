...
DEFINE VARIABLE f-cod_item-fim AS CHARACTER FORMAT "X(16)" INITIAL "ZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 17 BY .88 NO-UNDO.

DEFINE VARIABLE f-cod_item-ini AS CHARACTER FORMAT "X(16)" INITIAL "0" 
     LABEL "Item" 
     VIEW-AS FILL-IN 
     SIZE 17 BY .88 NO-UNDO.
...
DEFINE VARIABLE tg-zerados AS LOGICAL INITIAL no 
     LABEL "Incluir Itens com saldo Zero" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME f-pg-sel
     f-cod_item-ini AT ROW 1.25 COL 17 COLON-ALIGNED WIDGET-ID 12
     f-cod_item-fim AT ROW 1.29 COL 46 COLON-ALIGNED NO-LABEL WIDGET-ID 14
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY f-cod_item-ini f-cod_item-fim tg-zerados 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 f-cod_item-ini f-cod_item-fim tg-zerados 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.empresa         = i-ep-codigo-usuario
        ...
        .
    /*Selecao*/
         ASSIGN tt-param.cod_item_ini       = INPUT FRAME f-pg-sel f-cod_item-ini
                tt-param.cod_item_fim       = INPUT FRAME f-pg-sel f-cod_item-fim
