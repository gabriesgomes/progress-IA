...
DEFINE TEMP-TABLE tt_wms_item_endereco NO-UNDO LIKE wms_item_endereco
...
&SCOPED-DEFINE Program              WMS0107B
&SCOPED-DEFINE Version              1.00.00.000

&SCOPED-DEFINE DBOParent            wms_item
&SCOPED-DEFINE DBOTable             wms_item_endereco
&SCOPED-DEFINE DBOTempTable         tt_wms_item_endereco
&SCOPED-DEFINE DBOProgram           wmbo/bowms011.p
...
&Scoped-Define ENABLED-FIELDS tt_wms_item_endereco.cod_item ~
tt_wms_item_endereco.id_endereco 
&Scoped-define ENABLED-TABLES tt_wms_item_endereco
&Scoped-define FIRST-ENABLED-TABLE tt_wms_item_endereco
...
&Scoped-Define DISPLAYED-FIELDS tt_wms_item_endereco.cod_item ~
tt_wms_item_endereco.id_endereco 
&Scoped-define DISPLAYED-TABLES tt_wms_item_endereco
&Scoped-define FIRST-DISPLAYED-TABLE tt_wms_item_endereco
...
DEFINE FRAME fPage0
     tt_wms_item_endereco.cod_item AT ROW 1.33 COL 20 COLON-ALIGNED WIDGET-ID 102
          VIEW-AS FILL-IN 
          SIZE 17 BY .88
     f-desc-item AT ROW 1.33 COL 37 COLON-ALIGNED NO-LABEL WIDGET-ID 98
     tt_wms_item_endereco.id_endereco AT ROW 2.33 COL 20 COLON-ALIGNED WIDGET-ID 104
          VIEW-AS FILL-IN 
          SIZE 10 BY .88
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tt_wms_item_endereco T "?" NO-UNDO mgesp wms_item_endereco
      ADDITIONAL-FIELDS:
          FIELD r-rowid AS ROWID
      END-FIELDS.
   END-TABLES.
