/*
Objetivo: Busca Tarefa Conferencia
...
{utp/ut-api-action.i "pi-busca-tarefa-conferencia" "GET" "*" }
{utp/ut-api-notfound.i}

/*
http://10.3.0.5:8180/api/wmp/v1/buscaTarefaConferencia?idTarefa=***
*/

PROCEDURE pi-busca-tarefa-conferencia:
