/*
Objetivo: Listar Documentos Pendentes Armazenamento
...
{utp/ut-api-action.i "pi-lista-doctos-pendentes-armazenamento" "GET" "*" }
{utp/ut-api-notfound.i}

/*
http://10.3.0.5:8180/api/wmp/v1/listarDocPendentesArmazenamento
*/
...
PROCEDURE pi-lista-doctos-pendentes-armazenamento:
    ...
    FOR EACH wms_tarefa NO-LOCK 
        ...
        IF NOT AVAIL tt-documento THEN DO:
            CREATE tt-documento . ASSIGN 
                ...
                tt-documento.tipo_movimento = "Entrada" 
                .
    
            IF wms_documento.id_pack_list_origem <> 0 THEN DO:
                FIND FIRST wms_pack_list NO-LOCK
                    WHERE wms_pack_list.id_documento = wms_documento.id_pack_list_origem
                    .
