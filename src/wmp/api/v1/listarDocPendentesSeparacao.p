/*
Objetivo: Listar Documentos Pendentes Separa‡Æo
...
{utp/ut-api-action.i "pi-lista-doctos-pendentes-separacao" "GET" "*" }
{utp/ut-api-notfound.i}

/*
http://10.3.0.5:8180/api/wmp/v1/listarDocPendentesSeparacao
*/
...
PROCEDURE pi-lista-doctos-pendentes-separacao:
    ...
    FOR EACH wms_tarefa NO-LOCK 
        ...
        AND (wms_endereco.id_tipo_endereco = 1 /* Estoque */ OR
            wms_endereco.id_tipo_endereco = 3 /* Qualidade */ OR
            wms_endereco.id_tipo_endereco = 10 /* Rack */)
        :
