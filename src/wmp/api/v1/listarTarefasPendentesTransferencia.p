/*
Objetivo: Listar Tarefas Pendentes Transferencia
...
{utp/ut-api-action.i "pi-lista-tarefas-pendentes-transferencia" "GET" "*" }
{utp/ut-api-notfound.i}

/*
http://10.3.0.5:8180/api/wmp/v1/listarTarefasPendentesTransferencia
*/

PROCEDURE pi-lista-tarefas-pendentes-transferencia:
    ...
    FOR EACH wms_tarefa NO-LOCK 
        ...
        /* Inicio - Desconsiderar apenas ressuprimento de picking */
        ...
        IF lRessPicking THEN NEXT . 
        /* Fim - Desonsiderar apenas ressuprimento de picking */
