...
PUT UNFORMATTED
    "Id Endereco;Estab;Depos;Bloco;Rua;Coluna;N¡vel;Posi‡Æo;Qtde Armazenada;Qtde Destinada Sa¡da;Qtde Destinada Entrada"
    SKIP .
...
IF NOT tt-param.zerado THEN DO:
    FOR EACH wms_endereco NO-LOCK
        WHERE wms_endereco.id_endereco >= tt-param.id_endereco_ini
        AND wms_endereco.id_endereco <= tt-param.id_endereco_fim
        :
        ASSIGN 
            qtd_dest_ent = 0
            qtd_dest_sai = 0
