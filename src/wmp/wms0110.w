...
DEFINE TEMP-TABLE tt_wms_equip_transporte NO-UNDO LIKE wms_equip_transporte
...
&SCOPED-DEFINE Program              WMS0110
&SCOPED-DEFINE Version              1.00.00.000

&SCOPED-DEFINE DBOTable             wms_equip_transporte
&SCOPED-DEFINE DBOProgram           wmbo/bowms013.p
...
&SCOPED-DEFINE ProgramZoom          wmzoom/z01wms013.w
...
&SCOPED-DEFINE page0KeyFields       {&DBOTempTable}.id_equip_transporte         
...
&Scoped-Define ENABLED-FIELDS tt_wms_equip_transporte.id_equip_transporte ~
tt_wms_equip_transporte.descricao 
&Scoped-define ENABLED-TABLES tt_wms_equip_transporte
&Scoped-define FIRST-ENABLED-TABLE tt_wms_equip_transporte
...
&Scoped-Define DISPLAYED-FIELDS tt_wms_equip_transporte.id_equip_transporte ~
tt_wms_equip_transporte.descricao 
&Scoped-define DISPLAYED-TABLES tt_wms_equip_transporte
&Scoped-define FIRST-DISPLAYED-TABLE tt_wms_equip_transporte
...
DEFINE FRAME fPage0
     ...
     btHelp AT ROW 1.13 COL 86.72 HELP
          "Ajuda"
     tt_wms_equip_transporte.id_equip_transporte AT ROW 2.88 COL 20 COLON-ALIGNED WIDGET-ID 72
          VIEW-AS FILL-IN 
          SIZE 7 BY .88
     tt_wms_equip_transporte.descricao AT ROW 4.25 COL 20 COLON-ALIGNED WIDGET-ID 70
          VIEW-AS FILL-IN 
          SIZE 41 BY .88
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tt_wms_equip_transporte T "?" NO-UNDO mgesp wms_equip_transporte
      ADDITIONAL-FIELDS:
          FIELD r-rowid AS ROWID
      END-FIELDS.
   END-TABLES.
...
{cstddk/include/wWinGoToRecord.i
    &winName="Equipamento" &winSize=2
    &gotoField1=id_equip_transporte &sizeField1=11
    }
