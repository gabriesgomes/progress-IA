...
&SCOPED-DEFINE Program              WMS0301B
...
ASSIGN
    ...
    cb-tipo-movimento:SCREEN-VALUE IN FRAME fPage0 = STRING("1")
...
DO TRANSACTION ON ERROR UNDO , LEAVE ON STOP UNDO , LEAVE
    :
    RUN pi-destina-entrada-saldo IN hBOSaldoWMS({&DBOTempTable}.id_movimento) .
