...
DEFINE TEMP-TABLE tt_wms_rest_endereco_item NO-UNDO LIKE wms_rest_endereco_item
...
&SCOPED-DEFINE Program              WMS0105A
&SCOPED-DEFINE Version              1.00.00.000

&SCOPED-DEFINE DBOParent            wms_endereco
&SCOPED-DEFINE DBOTable             wms_rest_endereco_item
&SCOPED-DEFINE DBOTempTable         tt_wms_rest_endereco_item
&SCOPED-DEFINE DBOProgram           wmbo/bowms006.p

&SCOPED-DEFINE WinSon               YES

&SCOPED-DEFINE page0EnableWidgets   btOk btCancel

&SCOPED-DEFINE page0KeyFields       {&DBOTempTable}.id_endereco {&DBOTempTable}.it_codigo
...
&Scoped-Define ENABLED-FIELDS tt_wms_rest_endereco_item.id_endereco ~
tt_wms_rest_endereco_item.it_codigo 
&Scoped-define ENABLED-TABLES tt_wms_rest_endereco_item
&Scoped-define FIRST-ENABLED-TABLE tt_wms_rest_endereco_item
&Scoped-Define ENABLED-OBJECTS rtKey rtToolBar f-desc-item btOk btSave ~
btCancel 
&Scoped-Define DISPLAYED-FIELDS tt_wms_rest_endereco_item.id_endereco ~
tt_wms_rest_endereco_item.it_codigo 
&Scoped-define DISPLAYED-TABLES tt_wms_rest_endereco_item
&Scoped-define FIRST-DISPLAYED-TABLE tt_wms_rest_endereco_item
...
DEFINE FRAME fPage0
     tt_wms_rest_endereco_item.id_endereco AT ROW 1.33 COL 20 COLON-ALIGNED WIDGET-ID 82
          VIEW-AS FILL-IN 
          SIZE 10 BY .88
     tt_wms_rest_endereco_item.it_codigo AT ROW 2.33 COL 20 COLON-ALIGNED WIDGET-ID 84
          VIEW-AS FILL-IN 
          SIZE 17 BY .88
     f-desc-item AT ROW 2.33 COL 37 COLON-ALIGNED NO-LABEL WIDGET-ID 80
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tt_wms_rest_endereco_item T "?" NO-UNDO mgesp wms_rest_endereco_item
      ADDITIONAL-FIELDS:
          FIELD r-rowid AS ROWID
      END-FIELDS.
   END-TABLES.
...
/*Evt Cod Lista Bonus*/
{&DBOTempTable}.it_codigo:LOAD-MOUSE-POINTER("image/lupa.cur":U) IN FRAME fPage0 .
ON 'F5':U , "MOUSE-SELECT-DBLCLICK":U OF {&DBOTempTable}.it_codigo IN FRAME fPage0
DO:
    {method/zoomfields.i 
        &ProgramZoom="wmzoom/z01wms007.w"
        &FieldZoom1="cod_item"
        &FieldScreen1="{&DBOTempTable}.it_codigo"
        &Frame1="fPage0"
...
END.
ON 'LEAVE':U OF {&DBOTempTable}.it_codigo IN FRAME fPage0
DO:
    ASSIGN f-desc-item:SCREEN-VALUE IN FRAME fPage0 = "" .
    FOR FIRST ITEM FIELDS(it-codigo desc-item) NO-LOCK
        WHERE ITEM.it-codigo = INPUT FRAME fPage0 {&DBOTempTable}.it_codigo
        :
...
APPLY "LEAVE" TO {&DBOTempTable}.it_codigo IN FRAME fPage0 .
