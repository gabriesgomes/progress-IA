...
DEFINE TEMP-TABLE tt_wms_tipo_endereco NO-UNDO LIKE wms_tipo_endereco
...
&SCOPED-DEFINE Program              WMS0103
&SCOPED-DEFINE Version              1.00.00.000

&SCOPED-DEFINE DBOTable             wms_tipo_endereco
&SCOPED-DEFINE DBOProgram           wmbo/bowms003.p
...
&SCOPED-DEFINE ProgramZoom          wmzoom/z01wms003.w
...
&SCOPED-DEFINE page0KeyFields       {&DBOTempTable}.id_tipo_endereco        
...
&Scoped-Define ENABLED-FIELDS tt_wms_tipo_endereco.id_tipo_endereco ~
tt_wms_tipo_endereco.descricao 
&Scoped-define ENABLED-TABLES tt_wms_tipo_endereco
&Scoped-define FIRST-ENABLED-TABLE tt_wms_tipo_endereco
...
&Scoped-Define DISPLAYED-FIELDS tt_wms_tipo_endereco.id_tipo_endereco ~
tt_wms_tipo_endereco.descricao 
&Scoped-define DISPLAYED-TABLES tt_wms_tipo_endereco
&Scoped-define FIRST-DISPLAYED-TABLE tt_wms_tipo_endereco
...
DEFINE FRAME fPage0
     ...
     btHelp AT ROW 1.13 COL 86.72 HELP
          "Ajuda"
     tt_wms_tipo_endereco.id_tipo_endereco AT ROW 2.79 COL 24 COLON-ALIGNED WIDGET-ID 64
          VIEW-AS FILL-IN 
          SIZE 4 BY .88
     tt_wms_tipo_endereco.descricao AT ROW 4.21 COL 24 COLON-ALIGNED WIDGET-ID 62
          VIEW-AS FILL-IN 
          SIZE 51 BY .88
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tt_wms_tipo_endereco T "?" NO-UNDO mgesp wms_tipo_endereco
      ADDITIONAL-FIELDS:
          FIELD r-rowid AS ROWID
      END-FIELDS.
   END-TABLES.
...
{cstddk/include/wWinGoToRecord.i
    &winName="Tipo Endereco" &winSize=2
    &gotoField1=id_tipo_endereco &sizeField1=11
    }
