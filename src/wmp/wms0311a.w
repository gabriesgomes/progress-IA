...
cb-status-tarefa btOK btCancel 
&Scoped-Define DISPLAYED-OBJECTS f-id-tarefa-ini f-id-tarefa-fim ~
f-cod-item-ini f-cod-item-fim cb-status-tarefa 
...
DEFINE FRAME fPage0
     ...
     cb-status-tarefa AT ROW 3.25 COL 20 COLON-ALIGNED WIDGET-ID 106
     btOK AT ROW 4.83 COL 2 WIDGET-ID 10
     btCancel AT ROW 4.83 COL 13 WIDGET-ID 6
     btHelp AT ROW 4.83 COL 68.29 WIDGET-ID 8
     rtToolBar AT ROW 4.58 COL 1 WIDGET-ID 12
