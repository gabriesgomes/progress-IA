...
DEFINE VARIABLE f-cod-item-fim AS CHARACTER FORMAT "X(16)":U INITIAL "ZZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 17 BY .88 NO-UNDO.

DEFINE VARIABLE f-cod-item-ini AS CHARACTER FORMAT "X(16)":U 
     LABEL "Item" 
     VIEW-AS FILL-IN 
     SIZE 17 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     f-cod-item-ini AT ROW 1.25 COL 17 COLON-ALIGNED WIDGET-ID 2
     f-cod-item-fim AT ROW 1.25 COL 46 COLON-ALIGNED NO-LABEL WIDGET-ID 8
     IMAGE-1 AT ROW 1.25 COL 38 WIDGET-ID 4
     IMAGE-2 AT ROW 1.25 COL 43 WIDGET-ID 6
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY f-cod-item-ini f-cod-item-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 f-cod-item-ini f-cod-item-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.empresa         = i-ep-codigo-usuario
        ...
        .
    /*Selecao*/
    ASSIGN tt-param.cod-item-ini    = INPUT FRAME f-pg-sel f-cod-item-ini
           tt-param.cod-item-fim    = INPUT FRAME f-pg-sel f-cod-item-fim 
        .
