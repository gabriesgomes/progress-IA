...
DEF TEMP-TABLE tt-param NO-UNDO
    ...
    /*Selecao*/
	FIELD id_endereco-ini LIKE wms_saldo.id_endereco
	FIELD id_endereco-fim LIKE wms_saldo.id_endereco
	...
	FIELD cod_item-ini    LIKE wms_saldo.cod_item
	FIELD cod_item-fim    LIKE wms_saldo.cod_item
