...
&SCOPED-DEFINE program_name         wms0404
...
DEFINE VARIABLE f-id_endereco-fim AS INTEGER FORMAT "->,>>>,>>9" INITIAL 9999999 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE tg-zerados AS LOGICAL INITIAL no 
     LABEL "Incluir Enderecos com saldo Zero" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME f-pg-sel
     f-id_endereco-ini AT ROW 1.25 COL 17 COLON-ALIGNED WIDGET-ID 12
     f-id_endereco-fim AT ROW 1.25 COL 46 COLON-ALIGNED NO-LABEL WIDGET-ID 14
     tg-zerados AT ROW 2.5 COL 19 WIDGET-ID 16
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY f-id_endereco-ini f-id_endereco-fim tg-zerados 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 f-id_endereco-ini f-id_endereco-fim tg-zerados 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.empresa         = i-ep-codigo-usuario
        ...
        .
    /*Selecao*/
         ASSIGN tt-param.id_endereco_ini       = INPUT FRAME f-pg-sel f-id_endereco-ini
                tt-param.id_endereco_fim       = INPUT FRAME f-pg-sel f-id_endereco-fim
                tt-param.zerados            = INPUT FRAME f-pg-sel tg-zerados  
             .
