DEF TEMP-TABLE tt-item NO-UNDO
    ...
    FIELD nro-docto         AS CHAR     LABEL "Nro Docto"
    FIELD cod-item          AS CHAR     LABEL "Item"        FORMAT "x(20)"
    FIELD desc-item         AS CHAR     LABEL "Descri‡Æo"   FORMAT "x(80)"
    FIELD qtde-item         AS DECIMAL  LABEL "Quantidade" 
    FIELD id-item-documento AS INT 
    .
...
DEF TEMP-TABLE tt-etiqueta NO-UNDO
    ...
    FIELD cod-emitente-docto    AS INT
    FIELD nat-operacao          AS CHAR
    FIELD cliente               AS CHAR
    FIELD pedido                AS CHAR
    FIELD transp                AS CHAR
    FIELD volume                AS DECIMAL  LABEL "Volume"  FORMAT ">>>,>>>,>>9.9999"
    FIELD volumeSeq             AS INT INIT 0
    FIELD volumeTotal           AS INT INIT 0
