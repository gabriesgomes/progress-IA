...
&SCOPED-DEFINE program_name         WMS0407
...
DEFINE VARIABLE f-cod_item-fim AS CHARACTER FORMAT "X(256)" INITIAL "ZZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME f-pg-sel
     f-id_item_documento-ini AT ROW 1.25 COL 17 COLON-ALIGNED
     f-id_item_documento-fim AT ROW 1.25 COL 47 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     f-id_documento-ini AT ROW 2.25 COL 17 COLON-ALIGNED WIDGET-ID 30
     f-id_documento-fim AT ROW 2.25 COL 47 COLON-ALIGNED NO-LABEL WIDGET-ID 32
     f-cod_item-ini AT ROW 3.25 COL 17 COLON-ALIGNED WIDGET-ID 14
     f-cod_item-fim AT ROW 3.25 COL 47 COLON-ALIGNED NO-LABEL WIDGET-ID 26
     IMAGE-1 AT ROW 1.25 COL 40
     IMAGE-2 AT ROW 1.25 COL 45
     IMAGE-3 AT ROW 2.25 COL 40 WIDGET-ID 6
     IMAGE-4 AT ROW 2.25 COL 45 WIDGET-ID 8
     IMAGE-5 AT ROW 3.25 COL 40 WIDGET-ID 18
     IMAGE-7 AT ROW 3.25 COL 45 WIDGET-ID 22
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY f-id_item_documento-ini f-id_item_documento-fim f-id_documento-ini 
          f-id_documento-fim f-cod_item-ini f-cod_item-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-7 
         f-id_item_documento-ini f-id_item_documento-fim f-id_documento-ini 
         f-id_documento-fim f-cod_item-ini f-cod_item-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
