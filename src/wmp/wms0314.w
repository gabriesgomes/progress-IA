...
&SCOPED-DEFINE FolderLabels         Itens,Observaá‰es
...
&SCOPED-DEFINE page0EnableWidgets   btImpressao
...
&SCOPED-DEFINE page1SonProgram      wmp/wms0314a.w

&SCOPED-DEFINE page2EnableWidgets   
&SCOPED-DEFINE page2DisplayFields   {&DBOTempTable}.observacoes
...
&Scoped-define INTERNAL-TABLES {&page1DBOTable} item
...
btSave btImpressao btQueryJoins btReportsJoins btExit btHelp ~
cb-tipo-documento cb-status-docto-wms 
...
DEFINE BUTTON btImpressao 
     IMAGE-UP FILE "IMAGE\2023\toolbar\bmg-causa.png":U
     LABEL "Impress∆o" 
     SIZE 4 BY 1.25.
...
DEFINE FRAME fPage0
     ...
     btImpressao AT ROW 1.13 COL 65 WIDGET-ID 110
     ...
     btHelp AT ROW 1.13 COL 86.72 HELP
          "Ajuda"
     tt_wms_documento.id_documento AT ROW 2.88 COL 17 COLON-ALIGNED WIDGET-ID 56
          VIEW-AS FILL-IN 
          SIZE 15 BY .88
     tt_wms_documento.data_geracao AT ROW 4.5 COL 17 COLON-ALIGNED WIDGET-ID 58
          VIEW-AS FILL-IN 
          SIZE 10 BY .88
     tt_wms_documento.usuar_geracao AT ROW 4.5 COL 45 COLON-ALIGNED WIDGET-ID 60
          VIEW-AS FILL-IN 
          SIZE 13 BY .88
     cb-tipo-documento AT ROW 4.5 COL 69 COLON-ALIGNED WIDGET-ID 106
     cb-status-docto-wms AT ROW 5.5 COL 17 COLON-ALIGNED WIDGET-ID 108
     tt_wms_documento.cod_estabel AT ROW 5.5 COL 45 COLON-ALIGNED WIDGET-ID 62
          VIEW-AS FILL-IN 
          SIZE 6 BY .88
     tt_wms_documento.nro_docto AT ROW 5.5 COL 69 COLON-ALIGNED WIDGET-ID 78
          VIEW-AS FILL-IN 
          SIZE 17 BY .88
     tt_wms_documento.serie_docto AT ROW 6.5 COL 17 COLON-ALIGNED WIDGET-ID 80
          VIEW-AS FILL-IN 
          SIZE 6 BY .88
     tt_wms_documento.cod_emitente AT ROW 6.5 COL 45 COLON-ALIGNED WIDGET-ID 74
          VIEW-AS FILL-IN 
          SIZE 10 BY .88
     tt_wms_documento.nat_operacao AT ROW 6.5 COL 69 COLON-ALIGNED WIDGET-ID 76
          VIEW-AS FILL-IN 
          SIZE 7 BY .88
     tt_wms_documento.cod_embarque AT ROW 7.5 COL 17 COLON-ALIGNED WIDGET-ID 72
          VIEW-AS FILL-IN 
          SIZE 11 BY .88
     tt_wms_documento.identificador AT ROW 7.5 COL 45 COLON-ALIGNED WIDGET-ID 114
          VIEW-AS FILL-IN 
          SIZE 23 BY .88
...
DEFINE FRAME fPage2
     tt_wms_documento.observacoes AT ROW 1.25 COL 1 NO-LABEL WIDGET-ID 10
          VIEW-AS FILL-IN 
          SIZE 84.14 BY 5.75
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3.57 ROW 10.29
         SIZE 84.43 BY 6.5
...
/* SETTINGS FOR FRAME fPage2
                                                                        */
/* SETTINGS FOR FILL-IN tt_wms_documento.observacoes IN FRAME fPage2
   ALIGN-L                                                              */
...
&Scoped-define SELF-NAME btImpressao
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btImpressao wWindow
ON CHOOSE OF btImpressao IN FRAME fPage0 /* Impress∆o */
DO:
  RUN wmp/wms0314rp.p
...
DO:
    ...
    ELSE DO:
        RUN utp/ut-msgs.p
                (INPUT "Show":U , INPUT "15825" , INPUT
                 "Situaá∆o do documento n∆o permite alteraá∆o." + "~~" + 
                 "Documento n∆o pode ser alterado.")
                .
    END.*/
END.
...
------------------------------------------------------------------------------*/
DO WITH FRAME fPage0:
    ASSIGN cb-tipo-documento:SENSITIVE = FALSE .
END .
END PROCEDURE.
...
END.
DO WITH FRAME fPage0:
    ASSIGN cb-tipo-documento:SENSITIVE = TRUE .
END .
