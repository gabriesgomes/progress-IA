...
/*
Autor: JosÇ Telles
Objetivo: Espec°fico Finalizar Expediá‰es Retroativas
*/
...
DEFINE VARIABLE f-data-expedicao AS DATE FORMAT "99/99/9999":U 
     LABEL "Data Expediá∆o" 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE f-id-packlist AS INTEGER FORMAT ">>>,>>>,>>>,>>9" INITIAL 0 
     LABEL "Packlist" 
     VIEW-AS FILL-IN 
     SIZE 17 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     f-id-packlist AT ROW 1.25 COL 17 COLON-ALIGNED WIDGET-ID 2
     f-id-documento AT ROW 2.25 COL 17 COLON-ALIGNED
     f-data-expedicao AT ROW 3.25 COL 17 COLON-ALIGNED WIDGET-ID 4
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
DO WITH FRAME f-pg-sel
    :
    ASSIGN f-data-expedicao:SCREEN-VALUE = STRING(TODAY) .
END.
/**/
RETURN "OK":U .
END PROCEDURE.
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY f-id-packlist f-id-documento f-data-expedicao 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE f-id-packlist f-id-documento f-data-expedicao 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    /*Selecao*/
    ASSIGN
        tt-param.id-packlist = INT(INPUT FRAME f-pg-sel f-id-packlist)
        tt-param.id-documento = INT(INPUT FRAME f-pg-sel f-id-documento)
        tt-param.data-expedicao = INPUT FRAME f-pg-sel f-data-expedicao
        .
