...
DEFINE VARIABLE f-cod-usuario AS CHARACTER FORMAT "x(16)" 
     LABEL "Usu rio" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME f-pg-sel
     f-cod-usuario AT ROW 1.25 COL 17 COLON-ALIGNED
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY f-cod-usuario 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE f-cod-usuario 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    /*Selecao*/
    ASSIGN
        tt-param.cod-usuario = INPUT FRAME f-pg-sel f-cod-usuario
        .
