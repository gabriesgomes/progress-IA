...
DEFINE TEMP-TABLE tt_wms_equip_coleta NO-UNDO LIKE wms_equip_coleta
...
&SCOPED-DEFINE Program              WMS0109
&SCOPED-DEFINE Version              1.00.00.000

&SCOPED-DEFINE DBOTable             wms_equip_coleta
&SCOPED-DEFINE DBOProgram           wmbo/bowms012.p
...
&SCOPED-DEFINE ProgramZoom          wmzoom/z01wms012.w
...
&SCOPED-DEFINE page0KeyFields       {&DBOTempTable}.id_equip_coleta         
...
&Scoped-Define ENABLED-FIELDS tt_wms_equip_coleta.id_equip_coleta ~
tt_wms_equip_coleta.descricao 
&Scoped-define ENABLED-TABLES tt_wms_equip_coleta
&Scoped-define FIRST-ENABLED-TABLE tt_wms_equip_coleta
...
&Scoped-Define DISPLAYED-FIELDS tt_wms_equip_coleta.id_equip_coleta ~
tt_wms_equip_coleta.descricao 
&Scoped-define DISPLAYED-TABLES tt_wms_equip_coleta
&Scoped-define FIRST-DISPLAYED-TABLE tt_wms_equip_coleta
...
DEFINE FRAME fPage0
     ...
     btHelp AT ROW 1.13 COL 86.72 HELP
          "Ajuda"
     tt_wms_equip_coleta.id_equip_coleta AT ROW 2.88 COL 20 COLON-ALIGNED WIDGET-ID 72
          VIEW-AS FILL-IN 
          SIZE 7 BY .88
     tt_wms_equip_coleta.descricao AT ROW 4.25 COL 20 COLON-ALIGNED WIDGET-ID 70
          VIEW-AS FILL-IN 
          SIZE 41 BY .88
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tt_wms_equip_coleta T "?" NO-UNDO mgesp wms_equip_coleta
      ADDITIONAL-FIELDS:
          FIELD r-rowid AS ROWID
      END-FIELDS.
   END-TABLES.
...
{cstddk/include/wWinGoToRecord.i
    ...
    &gotoField1=id_equip_coleta &sizeField1=11
    }
