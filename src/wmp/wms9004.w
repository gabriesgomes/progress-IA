...
DEFINE VARIABLE f-id-movimento AS INTEGER FORMAT ">>>,>>>,>>>,>>9" INITIAL 0 
     LABEL "ID Movimento" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.

DEFINE VARIABLE f-quantidade AS DECIMAL FORMAT "->>>,>>9.99" INITIAL 0 
     LABEL "Quantidade" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     f-id-movimento AT ROW 1.25 COL 17 COLON-ALIGNED WIDGET-ID 2
     f-quantidade AT ROW 2.25 COL 17 COLON-ALIGNED
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY f-id-movimento f-quantidade 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE f-id-movimento f-quantidade 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    /*Selecao*/
    ASSIGN
        tt-param.id-movimento = INT(INPUT FRAME f-pg-sel f-id-movimento)
        tt-param.quantidade = INT(INPUT FRAME f-pg-sel f-quantidade)
        .
